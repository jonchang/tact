...
@example(
    ...
    sampling=0.06298810337307759,
)
@given(
    ages=st.lists(st.floats(min_value=0, allow_infinity=False, allow_nan=False, exclude_min=True), min_size=1).map(
        sorted
    ),
