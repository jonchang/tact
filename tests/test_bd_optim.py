...
@given(ages=st.lists(st.floats(min_value=0, allow_infinity=False, allow_nan=False, exclude_min=True), min_size=1).map(sorted), sampling=st.floats(min_value=1e-9, max_value=1))
